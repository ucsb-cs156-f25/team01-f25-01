...
public class ArticlesControllerTests extends ControllerTestCase {
  ...
  public void logged_in_user_can_get_all_articles() throws Exception {
    ...
    Article article1 =
        Article.builder()
            .title("firstArticle")
            .url("http://example.com/firstArticle")
            .explanation("Example-of-first-article")
  ...
  public void an_admin_user_can_post_a_new_article() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/articles/post?title=firstArticle&url=http://example.com/firstArticle&explanation=Example-of-first-article&email=user@gmail.com&dateAdded=2022-01-03T00:00:00")
                    .with(csrf()))
  ...
  public void admin_cannot_edit_article_that_does_not_exist() throws Exception {
    ...
    Article edtitedArticle =
        Article.builder()
            .title("secondArticle")
            .url("http://example.com/secondArticle")
            .explanation("Example-of-second-article")
